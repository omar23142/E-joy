...
export class VocabularyService {
  ...
  async create(dto: CreateVocabularyDto, user: User) {
    ...
    // let sugestionTranslate: string[] | undefined = await this.translateService.translate(word, sentenceToHash);
    // console.log('translatreToArray from logic:', sugestionTranslate);
